...
function Login1() {
    ...
    axios.post("http://localhost:8080/login", inputs)
      .then((response) => {
        ...
        if (response.data === "success") {
          navigate('/Custom'); // Redirect to dashboard upon successful login
        } else {
  ...
  return (
    <div style={{
      background: 'url("https://images.pexels.com/photos/4551156/pexels-photo-4551156.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1")',
